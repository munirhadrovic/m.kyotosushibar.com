...
<html>
	<head>
		...
		<title>Kyoto - Japanese Cuisine Sushi Bar</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://kyotosushibar.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<!-- 
				...
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-user ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">About</a></div>
                    <div class="ui-block-b"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-bars ui-btn-icon-right buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Menu</a></div>
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Catering</a></div>
                    <div class="ui-block-b"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-right buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Gallery</a></div>
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Party<br>Trays</a></div>
			...
			<!-- POPUP FOR FIND US -->
			<h2>Welcome to the Web Site of Kyoto Sushi Bar</h2>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Party Trays</a></li>							
